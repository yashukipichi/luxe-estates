...
function showLeadModal(onSuccess) {
  ...
  overlay.innerHTML = `
    ...
    ">
      ...
      <div style="display:flex;flex-direction:column;gap:0.75rem;margin-bottom:1.25rem">
        ...
        <div class="phone-field-wrap" id="phone-field-wrap" style="
        ...
        ">
          <select id="lead-phone-country" class="phone-country-select" style="
          ...
          <input id="lead-phone-number" type="tel" placeholder="Phone number *" maxlength="15" autocomplete="tel-national" style="
            flex:1;
  ...
  phoneInput.addEventListener('focus', () => {
    phoneWrap.classList.add('focused');
    phoneWrap.style.borderColor = '#c9a96e';
    phoneWrap.style.boxShadow   = '0 0 0 3px rgba(201,169,110,0.12)';
  });
  phoneInput.addEventListener('blur',  () => {
    phoneWrap.classList.remove('focused');
    phoneWrap.style.borderColor = 'rgba(201,169,110,0.22)';
    phoneWrap.style.boxShadow   = 'none';
  });
